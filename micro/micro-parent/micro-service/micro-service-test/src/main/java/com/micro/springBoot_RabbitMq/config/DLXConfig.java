...
public class DLXConfig {
    ...
    //定义交换机名称
    public static final String TT_DLX_EXCHANGE_01 = "TT_DLX_DLX_EXCHANGE_01";
    public static final String DLX_EXCHANGE_01 = "DLX_EXCHANGE_01";
    // 路由键
    public static final String TT_DLX_ROUTING_KEY_01 = "TT_DLX_DLX_ROUTING_KEY_01";
    public static final String DLX_ROUTING_KEY_01 = "DLX_ROUTING_KEY_01";
    //1 定义队列
    @Bean
    ...
    @Bean
    public Queue DLX_02(){
        return new Queue(DLX_QUEUE_01,false);//为true队列持久化
    }
    ...
    public DirectExchange TT_DLX_Exchange_01(){
        ...
        return new DirectExchange(TT_DLX_EXCHANGE_01,false,false);
    }
    @Bean
