package com.micro.MQTest.routing_direct.consumer;
...
public class ConsumerDirect_1 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        System.out.println("消费者启动---*****----11111");
        //建立mq连接
        ...
        //消费者队列绑定交换机 并指定路由键
        channel.queueBind(QUEUE_NAME,DESTINATION_NAME,"direct_1");
        channel.queueBind(QUEUE_NAME,DESTINATION_NAME,"direct_2");
        //消费者监听消息
